  ...
  for (t in 1:T) {
    ...
    if (t > 1) {
      ...
      for (n in 1:N) {
        ...
        if (I_1[n,t] == 1) { mu_D[n,t] = normal_rng(mu_D[n,t-1], varsigma_D * I_4[n,t] + kappa_D * I_5[n,t]); }
    ...
    for (n in 1:N) {
      ...
      real sigma_P;
      sigma_P = sqrt(square(varsigma_D * I_4[n,t] + kappa_D * I_5[n,t]) + square(varsigma_C));
